...
<head>
    ...
    <title>Formulario de adopcion de gatos</title>
</head>
<body>
<nav class="navB">
        <div class="header">
    ...
    <div class="linea"></div>
    <div class="banner">
        <img style="width:100%" src="imagenes/fadop_g.png" alt="">
    </div>
    ...
    <div style="background-color:#120755;width: 100%;display: flex;flex-direction: row;">
        ...
        <form style="display:flex;flex-direction:column;color:white;margin:10px;" action="" method="post">
            ...
            <label for="chk" aria-hidden="true">¿Has tenido gatos antes? ¿Qué pasó con ellos?</label>
            <input name="Res_4" type="text" placeholder="¿Has tenido gatos antes? ¿Qué pasó con ellos?" required="">

            <label for="chk" aria-hidden="true">¿Cuánto tiempo pasará el gato sin compañía humana?</label>
            <input name="Res_5" type="text" placeholder="¿Cuánto tiempo pasará el gato sin compañía humana?" required="">

            <label for="chk" aria-hidden="true">¿Dónde dormirá el gato?</label>
            <input name="Res_6" type="text" placeholder="¿Dónde dormirá el gato?" required=""><br>

            <input style="background-color:#F24E1E;border:none;border-radius:30px;margin-top:10px;margin-bottom:10px;width:30%;padding:10px;color:white;font-size:20px" name="enviar" id="enviar" type="submit" value="Enviar">
        </div>

        <div style="width: 50%;display: flex;flex-direction: column;color:white;margin:10px;">
            <label for="chk" aria-hidden="true">¿El gato puede salir a la calle durante el día?</label>
            <input name="Res_7" type="text" placeholder="¿El gato puede salir a la calle durante el día?" required=""> 

            <label for="chk" aria-hidden="true">Si sales de vacaciones, ¿con quién dejarás al gato?</label>
            <input name="Res_8" type="text" placeholder="Si sales de vacaciones, ¿con quién dejarás al gato?" required=""><br>
            ...
            <label for="chk" aria-hidden="true">¿Por qué quieres adoptar a este gato?</label>
            <input name="Res_9" type="text" placeholder="¿Por qué quieres adoptar a este gato?" required="">

            <label for="chk" aria-hidden="true">¿Te ha gustado algún otro gato de la lista en concreto?</label>
            <input name="Res_10" type="text" placeholder="¿Te ha gustado algún otro gato de la lista en concreto?" required="">

            <label for="chk" aria-hidden="true">Profesion</label>
            <input name="profesion" type="text" placeholder="Profesion" required="">
            ...
            <input name="Res_11" type="text" placeholder="Perfil en facebook" required="">

            <label for="chk" aria-hidden="true">Perfil en Instagram</label>
            <input name="Res_12" type="text" placeholder="Perfil en Instagram" required="">

            <label for="chk" aria-hidden="true">¿Cómo conociste nuestra fundación?</label>
            <input name="Res_13" type="text" placeholder="¿Cómo conociste nuestra fundación?" required=""><br>
