...
<nav class="navB">
    ...
    <div class="linea"></div>
    <div class="banner">
        <img style="width:100%" src="imagenes/b_gato.png" alt="">
    </div>
...
if(isset($_POST['buscar'])){
    $buscar = $_POST['search'];
    require 'conexion_db.php';
    $sql = "SELECT id_gato, nombre, fecha_ingreso, sexo, edad, descripcion, imagen FROM gatos WHERE nombre = '$buscar'";
