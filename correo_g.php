...
<nav class="navB">
    ...
    <div style="background-color:#F24E1E; height:100px; display:flex; align-items:center;">
        <h5 style="margin-left:20px; color:white;font-family: 'Italiana', serif; font-size: 20px;">Solicitud de adopcion de un gato</h5>
    </div>
<?php
if(isset($_POST['formulario'])){

   require 'conexion_db.php';
   $sql = "SELECT * FROM form_gato";
   ...
   ?>
    ...
    <div style="background-color:#120755; color:white;margin:50px;">
        ...
        <h6>¿Cuánto tiempo pasará el perro sin compañía humana?:  <?php echo $record['Res_5']; ?></h6>
    
        <h6>¿Dónde dormirá el gato?:  <?php echo $record['Res_6']; ?></h6>
        <h6>¿El gato puede salir a la calle durante el día?:  <?php echo $record['Res_7']; ?></h6>
    
        <h6>Si sale de vacaciones, ¿con quién dejará al gato?:  <?php echo $record['Res_8']; ?></h6>
    
        <h6>S compromete a hacerte cargo de él el resto de su vida, una media de 15 años?:  <?php echo $record['opcion2']; ?></h6>
    
        <h6>¿Tiene la capacidad económica necesaria para mantenerlo?:  <?php echo $record['opcion3']; ?></h6>
    
        <h6>¿Por qué quiere adoptar a este gato?:  <?php echo $record['Res_9']; ?></h6>
        <h6>¿Le gusto algún otro gato de la lista en concreto?:  <?php echo $record['Res_10']; ?></h6>
        <h6>Profesión:  <?php echo $record['profesion']; ?></h6>
        <h6>Celular :  <?php echo $record['celular']; ?></h6>
        <h6>Email :  <?php echo $record['correo']; ?></h6>
        <h6>Perfil en facebook:  <?php echo $record['Res_11']; ?></h6>
        <h6>Perfil en Instagram:  <?php echo $record['Res_12']; ?></h6>
        <h6>¿Cómo conocio nuestra fundación?:  <?php echo $record['Res_13']; ?></h6>
