...
<nav class="navB">
    ...
    <div class="linea"></div>
    <div class="banner">
        <img style="width:100%" src="imagenes/ingresar_gato.png" alt="">
    </div>
    <div style="background-color:#F24E1E; height:100px; display:flex; align-items:center;">
        <h5 style="margin-left:20px; color:white;font-family: 'Italiana', serif; font-size: 20px;">Añade los datos del gato abajo para que esté registrado en la base de datos:</h5>
    </div>
    ...
    <div style="background-color:#120755;width: 100%;display: flex;flex-direction: row;justify-content:center;">
        <div style="width: 50%;display: flex;flex-direction: column;">
            <form style="display:flex;flex-direction:column;color:white;margin:10px;height:auto;" action="" method="post" enctype="multipart/form-data">
                <label for="chk" aria-hidden="true">Nombre del gato</label>
                <input id="nombre" name="nombre" type="text" placeholder="Nombre del gato" required="">
                ...
                <label for="chk" aria-hidden="true">Subir una imagen</label>
