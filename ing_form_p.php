...
// Verifico que los campos enviados desde el formulario no esten vacios y quito espacios en blanco
	if(!empty(trim($_POST['nombre'])) && !empty(trim($_POST['edad'])) && !empty(trim($_POST['correo'])) && !empty(trim($_POST['celular'])) && !empty(trim($_POST['profesion'])) && !empty(trim($_POST['colonia'])) && !empty(trim($_POST['delegacion'])) && !empty(trim($_POST['ciudad'])) && !empty(trim($_POST['cod_postal'])) && !empty(trim($_POST['Res_1'])) && !empty(trim($_POST['Res_2'])) && !empty(trim($_POST['Res_3'])) && !empty(trim($_POST['Res_4'])) && !empty(trim($_POST['Res_5'])) && !empty(trim($_POST['Res_6'])) && !empty(trim($_POST['Res_7'])) && !empty(trim($_POST['Res_8'])) && !empty(trim($_POST['Res_9'])) && !empty(trim($_POST['Res_10'])) && !empty(trim($_POST['Res_11'])) && !empty(trim($_POST['Res_12'])) && !empty(trim($_POST['Res_13'])) && !empty(trim($_POST['Res_14'])) && !empty(trim($_POST['Res_15'])) ){
        ...
        $Res_14 = mysqli_real_escape_string($db_connection, htmlspecialchars($_POST['Res_14']));
        $Res_15 = mysqli_real_escape_string($db_connection, htmlspecialchars($_POST['Res_15']));
		...
		$inserto_perro = mysqli_query($db_connection, "INSERT INTO `form_perro` (nombre, edad, correo, celular, profesion, colonia, delegacion, ciudad, cod_postal, Res_1, Res_2, Res_3,Res_4, Res_5, Res_6, Res_7, Res_8, Res_9, Res_10, Res_11, Res_12, Res_13, Res_14, Res_15, opcion1, opcion2, opcion3) VALUES ('$nombre ', '$edad', '$correo', '$celular', '$profesion', '$colonia', '$delegacion', '$ciudad', '$cod_postal', '$Res_1', '$Res_2', '$Res_3', '$Res_4', '$Res_5', '$Res_6', '$Res_7', '$Res_8', '$Res_9', '$Res_10', '$Res_11', '$Res_12', '$Res_13', '$Res_14', '$Res_15', '$opcion1', '$opcion2', '$opcion3')");
